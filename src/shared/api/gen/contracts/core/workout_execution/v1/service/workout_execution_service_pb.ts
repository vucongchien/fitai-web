...
export const AdminWorkoutExecutionService: GenService<{
  ...
  /**
   * Admin lấy thông tin thống kê tổng quan về các MotionSpecification
   *
   * @generated from rpc contracts.core.workout_execution.v1.service.AdminWorkoutExecutionService.GetMotionSpecificationStats
   */
  getMotionSpecificationStats: {
    methodKind: "unary";
    input: typeof GetMotionSpecificationStatsRequestSchema;
    output: typeof GetMotionSpecificationStatsResponseSchema;
  },
  /**
   * Admin tìm kiếm danh sách các MotionSpecification theo tên bài tập
   *
   * @generated from rpc contracts.core.workout_execution.v1.service.AdminWorkoutExecutionService.SearchMotionSpecifications
   */
  searchMotionSpecifications: {
    methodKind: "unary";
    input: typeof SearchMotionSpecificationsRequestSchema;
    output: typeof SearchMotionSpecificationsResponseSchema;
  },
}> = /*@__PURE__*/
