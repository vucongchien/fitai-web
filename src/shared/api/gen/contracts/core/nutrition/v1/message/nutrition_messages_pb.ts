...
/**
 * @generated from message contracts.core.nutrition.v1.message.MealScheduleItem
 */
export type MealScheduleItem = Message<"contracts.core.nutrition.v1.message.MealScheduleItem"> & {
  /**
   * "BREAKFAST", "LUNCH", "DINNER", "SNACK"
   *
   * @generated from field: string meal_type = 1;
   */
  mealType: string;

  /**
   * e.g. "07:00", "12:00", "15:30", "19:00"
   *
   * @generated from field: string scheduled_time = 2;
   */
  scheduledTime: string;
};

/**
 * Describes the message contracts.core.nutrition.v1.message.MealScheduleItem.
 * Use `create(MealScheduleItemSchema)` to create a new message.
 */
export const MealScheduleItemSchema: GenMessage<MealScheduleItem> = /*@__PURE__*/
  messageDesc(file_contracts_core_nutrition_v1_message_nutrition_messages, 22);

/**
 * @generated from message contracts.core.nutrition.v1.message.UpdateMealScheduleRequest
 */
export type UpdateMealScheduleRequest = Message<"contracts.core.nutrition.v1.message.UpdateMealScheduleRequest"> & {
  /**
   * @generated from field: string user_id = 1;
   */
  userId: string;
  ...
  /**
   * @generated from field: repeated contracts.core.nutrition.v1.message.MealScheduleItem schedules = 2;
   */
  schedules: MealScheduleItem[];
};

/**
 * Describes the message contracts.core.nutrition.v1.message.UpdateMealScheduleRequest.
 * Use `create(UpdateMealScheduleRequestSchema)` to create a new message.
 */
export const UpdateMealScheduleRequestSchema: GenMessage<UpdateMealScheduleRequest> = /*@__PURE__*/
  messageDesc(file_contracts_core_nutrition_v1_message_nutrition_messages, 23);

/**
 * @generated from message contracts.core.nutrition.v1.message.UpdateMealScheduleResponse
 */
export type UpdateMealScheduleResponse = Message<"contracts.core.nutrition.v1.message.UpdateMealScheduleResponse"> & {
  /**
  ...
  /**
   * @generated from field: repeated contracts.core.nutrition.v1.message.MealScheduleItem schedules = 3;
   */
  schedules: MealScheduleItem[];
};

/**
 * Describes the message contracts.core.nutrition.v1.message.UpdateMealScheduleResponse.
 * Use `create(UpdateMealScheduleResponseSchema)` to create a new message.
 */
export const UpdateMealScheduleResponseSchema: GenMessage<UpdateMealScheduleResponse> = /*@__PURE__*/
  messageDesc(file_contracts_core_nutrition_v1_message_nutrition_messages, 24);
